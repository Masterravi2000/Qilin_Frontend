...
import Wishlist from "../../../components/SvgIcons/BottomNavBar/HeartGreyIcon";
import SellIcon from "../../../components/SvgIcons/BottomNavBar/SellIcon"
...
const tabs = [
  ...
  { name: "sell", title: "sell", icon: SellIcon, href: "(app)/(tabs)/sell" }, 
